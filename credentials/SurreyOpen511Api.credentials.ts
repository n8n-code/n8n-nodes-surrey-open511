...
export class SurreyOpen511Api implements ICredentialType {
	name = 'N8nDevSurreyOpen511Api';

	displayName = 'surrey-open511 API';

	icon: Icon = { light: 'file:../nodes/SurreyOpen511/surrey-open511.png', dark: 'file:../nodes/SurreyOpen511/surrey-open511.dark.png' };
	...
	properties: INodeProperties[] = [
		{
			...
			description: 'The base URL of your surrey-open511 API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
